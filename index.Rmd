...
```{r, include=FALSE}
library(readr)
lunes <- as.Date ("2020-08-17")
jueves <- as.Date("2020-08-20")
...
### `r advdate(jueves, 1)`. Unidad 1. Presentación
...
### `r advdate(lunes, 2)`. Unidad 1. Estándares internacionales
...
### `r advdate(jueves, 2)`. Unidad 2. Concepto clásico y estructural
...
### `r advdate(lunes, 3)`. Unidad 2. Continuación
...
- CELS, "El acceso a la justicia como una cuestión de derechos humanos", en Informe Anual 2016, [acá](https://www.cels.org.ar/web/wp-content/uploads/2016/12/IA2016-09-acceso-a-la-justicia.pdf El acceso a la justicia como una cuestión
de derechos humanos)

### `r advdate(jueves, 3)`. Unidad 3. La práctica
...
### `r advdate(lunes, 4)`. Unidad 3. La práctica
...
### `r advdate(jueves, 4)`. Unidad 3. La práctica
...
### `r advdate(lunes, 5)`. Unidad 3. La práctica

c. LGBT
Trans
- Informe sombra CEDAW 2016, [aca](http://feim.org.ar/wp-content/uploads/2016/11/cedaw2016-general.pdf)
...
### `r advdate(jueves, 5)`. Unidad 3. La práctica
...
- CIDH, "Acceso a la justicia para Mujeres víctimas de violencia de género", disponible [acá](https://www.cidh.oas.org/pdf%20files/Informe%20Acceso%20a%20la%20Justicia%20Espanol%20020507.pdf)

### `r advdate(jueves, 6)`. Unidad 3. La práctica

e. Africanos

- Informe Defensoria CABA, [aca](https://drive.google.com/drive/u/0/folders/1H21mmL-L3fRGZtXUKyd7JPgXa8HehdHX)

### `r advdate(lunes, 7)`. Unidad 3. La práctica

e. Afrodescendientes
- Angela Davis, "Raza, Mujeres y clase", Capítulo 11,  Violación, racismo y el mito del violador negro.

- Anita Hill en las audiencias de confirmación de Clearence Thomas

### `r advdate(jueves, 7)`. Unidad 3. La práctica
...
### `r advdate(lunes, 8)`. Unidad 4. Garantias

- Halabi, Padec

### `r advdate(jueves, 8)`. Unidad 4. Garantias
